        ...
        <div className="flex w-full">
            <div className="mt-4 w-1/2 flex flex-col">
                ...
                <div className="w-full font-exo2 text-[#B4B4B4] text-[14px] mt-5 tracking-wider">
                    ...
                    But hold up, here's the best part. Unlike those stuffy old banks, we believe in transparency and empowerment. Every step of the way, you're in control of your assets, and you can witness their magical movements in real-time. It's like having a front-row seat to the most thrilling show on Earth!
                    ...
                    So, are you ready for an adventure like no other? Step into the world of the BTC Vault on the Stacks blockchain and join the ranks of fearless crypto pioneers. Get ready to be amazed, excited, and rewarded as you explore the possibilities of high-yield crypto savings. It's time to unleash the power of your BTC and embark on a wild ride with the BTC Vault!
            ...
            <div className="mt-4 w-1/2 flex flex-col px-10">
                <div className="flex flex-col w-full px-10">
                    <span className="font-exo2 text-white font-bold text-[24px] underline">Yearn Fees</span>
