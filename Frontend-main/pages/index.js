      ...
      <div className="flex flex-col h-full">
        <div className="flex h-full">
          ...
          <div className="w-[2px] h-full bg-[#2C2C2C]"></div>
          {
            ...
            <div className="flex flex-col w-full h-full items-center justify-center">
              <div className="flex justify-center items-center">
                <div className="bg-[#1E1E1E] w-[42px] h-[42px] rounded-full flex justify-center items-center hover:cursor-pointer" onClick={() => setStatus(1)}>
                    <span className="font-Exo2 text-[20px] text-white">1</span>
                </div>
                <hr className="w-[60px] bg-[#2c1d1d] opacity-20 border-t-2" />
                <div className="bg-[#C8C8C8] w-[42px] h-[42px] rounded-full flex justify-center items-center hover:cursor-pointer" onClick={() => setStatus(2)}>
                    <span className="font-Exo2 text-[20px]">2</span>
                </div>
              </div>
              <span className="font-exo2 mt-10 text-white text-[64px] font-bold">Welcome to Arcus.</span>
              <span className="text-[#C8C8C8] text-[36px] font-bold mt-10">Bitcoin DeFi.</span>
              <span className="text-[#B4B4B4] text-[28px] mt-3">Deposit into our vaults, and Earn rewards in Bitcoin!</span>
              <div className="flex justify-center">
                <div className="flex flex-col items-center justify-between w-full h-full">
                  <span className="text-white text-[24px] font-bold mt-[100px]">Don't Wait!</span>
                ...
                <div className="flex flex-col items-center justify-center w-full h-full ml-[100px]">
                  <span className="text-white text-[24px] font-bold mt-[100px]">Yield Vaults</span>
                  <button className='bg-[#42EACA] mt-5 rounded-[5px] w-[220px] text-center justify-center px-6 py-4 h-[60px] flex items-center ml-auto text-[24px] font-exo2 font-bold'>
          ...
          }
          {
            ...
            <div className="flex flex-col w-full h-full items-center justify-center">
              <div className="flex justify-center items-center">
                <div className="bg-[#C8C8C8] w-[42px] h-[42px] rounded-full flex justify-center items-center hover:cursor-pointer" onClick={() => setStatus(1)}>
                    <span className="font-Exo2 text-[20px]">1</span>
                </div>
                <hr className="w-[60px] bg-[#2C2C2C] opacity-20 border-t-2" />
                <div className="bg-[#1E1E1E] w-[42px] h-[42px] rounded-full flex justify-center items-center hover:cursor-pointer" onClick={() => setStatus(2)}>
                    <span className="font-Exo2 text-[20px] text-white">2</span>
                </div>
              </div>
              <span className="font-exo2 mt-10 text-white text-[64px] font-bold text-center">Forge your path to<br /> the Citadel</span>
              <span className="text-[#B4B4B4] text-[28px] mt-[70px]">Getr Edarly Access by signing up below!</span>
              <div className="flex justify-center">
                <div className="flex flex-col items-center justify-between w-full h-full">
